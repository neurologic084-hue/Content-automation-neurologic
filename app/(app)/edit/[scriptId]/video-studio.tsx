          ...
          <div className="mb-4">
            ...
            {CUSTOM_BROLL_COMING_SOON ? (
              <div className="w-full px-4 py-3 rounded-xl border border-dashed border-[#E4E4E0] text-[12px] text-[#A1A1AA] leading-relaxed" style={{ background: '#FAFAFA' }}>
                Soon you&rsquo;ll be able to paste one Google Drive folder link with your own clips (max 12) — the Edit variants will watch each clip, place it exactly where it fits what you&rsquo;re saying (muted, trimmed to size), and skip stock footage entirely.
              </div>
            ) : (
              <>
                <textarea
            ...
            {(variants.length ? variants : Array.from({ length: 1 })).map((variant, i) => {
              ...
              return (
                ...
                >
                  ...
                  {/* The render succeeded but could not use her own clips —
                      say so, or a video silently missing her B-roll looks
                      completely fine. */}
                  {v?.broll_notice && (
                    <div className="flex items-start gap-2 mb-3 px-3 py-2 rounded-xl" style={{ background: '#FFFBEB' }}>
                      <svg width="13" height="13" viewBox="0 0 24 24" fill="none" stroke="#B45309" strokeWidth="2" strokeLinecap="round" className="flex-shrink-0 mt-0.5" aria-hidden="true">
                        <path d="M10.29 3.86 1.82 18a2 2 0 0 0 1.71 3h16.94a2 2 0 0 0 1.71-3L13.71 3.86a2 2 0 0 0-3.42 0z" />
                        <line x1="12" y1="9" x2="12" y2="13" /><line x1="12" y1="17" x2="12.01" y2="17" />
                      </svg>
                      <span className="text-[11px] leading-relaxed" style={{ color: '#B45309' }}>{v.broll_notice}</span>
                    </div>
                  )}
